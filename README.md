...
- `docs/development/`: Development rules, coding rules, testing policy, questions, and versioning.
...
- Development rules, coding rules, testing policy, and versioning: [docs/development/development.md](docs/development/development.md), [docs/development/coding-rules.md](docs/development/coding-rules.md), [docs/development/testing-rules.md](docs/development/testing-rules.md), [docs/development/versioning-rules.md](docs/development/versioning-rules.md)

Current specifications and design decisions are documented in the canonical documents above.
...
- `docs/development/`: 開発ルール、コーディング規約、検証方針、未決定事項、バージョン管理
...
- 開発ルール・コーディング規約・テスト方針・バージョン管理: [docs/development/development.md](docs/development/development.md), [docs/development/coding-rules.md](docs/development/coding-rules.md), [docs/development/testing-rules.md](docs/development/testing-rules.md), [docs/development/versioning-rules.md](docs/development/versioning-rules.md)

現行の仕様・設計判断は上記の正本文書を参照します。
