...
- Development rules, coding rules, testing policy, versioning, and release operations: [docs/development/development.md](docs/development/development.md)
...
- 開発ルール・コーディング規約・テスト方針・バージョン管理・リリース運用: [docs/development/development.md](docs/development/development.md)
