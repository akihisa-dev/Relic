...
export function makeRelicApi(overrides: Partial<typeof window.relic> = {}): typeof window.relic {
  return {
    ...
    getWorkspaceChronicleCalendarSettings: vi.fn().mockResolvedValue({ ok: true, value: { baseCalendarName: "基準暦", calendars: [], visibleCalendarNames: ["基準暦"] } }),
    getWorkspaceGraph: vi.fn().mockResolvedValue({ ok: true, value: { links: [], nodes: [] } }),
    getWorkspaceTable: vi.fn().mockResolvedValue({ ok: true, value: { availableProperties: [], preferences: { columnWidths: [], fileColumnWidth: 260, filters: [], selectedProperties: [], sort: { direction: "asc", property: null }, wrappedProperties: [] }, rows: [] } }),
