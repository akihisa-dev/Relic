...
export function makeRelicApi(overrides: Partial<typeof window.relic> = {}): typeof window.relic {
  return {
    ...
    getWorkspaceChronicleCalendarSettings: vi.fn().mockResolvedValue({ ok: true, value: { baseCalendarName: "西暦", calendars: [], visibleCalendarNames: ["西暦"] } }),
    getWorkspaceGraph: vi.fn().mockResolvedValue({ ok: true, value: { links: [], nodes: [] } }),
    getWorkspaceTable: vi.fn().mockResolvedValue({ ok: true, value: { availableProperties: [], rows: [], selectedProperties: [] } }),
    ...
    onWorkspaceWatcherStatus: vi.fn().mockReturnValue(vi.fn()),
    openWorkspace: vi.fn(),
    ...
    saveWorkspaceChronicleCalendarSettings: vi.fn().mockResolvedValue({ ok: true, value: { baseCalendarName: "西暦", calendars: [], visibleCalendarNames: ["西暦"] } }),
    saveWorkspaceCharts: vi.fn().mockResolvedValue({ ok: true, value: [] }),
    saveWorkspaceTableProperties: vi.fn().mockResolvedValue({ ok: true, value: [] }),
