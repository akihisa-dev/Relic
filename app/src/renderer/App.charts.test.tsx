...
describe("App charts", () => {
  ...
  it("レールのチャートボタンからchronicleを持つファイルを表示できる", async () => {
    ...
    expect(renderResult.container.querySelector(".chronicle-tracks")).toHaveStyle({ height: "304px" });
    expect(renderResult.container.querySelector(".chronicle-fill")).toHaveStyle({ height: "304px" });
