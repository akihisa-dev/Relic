...
function renderSearch(overrides: Partial<Parameters<typeof CardsSidebarSearch>[0]> = {}) {
  const props = {
...
describe("CardsSidebarSearch", () => {
  ...
  it("shows frontmatter field and value candidates in property search mode", () => {
    ...
    const cardSearchInput = screen.getByLabelText("Card search");

    expect(cardSearchInput).toHaveAttribute("list", "cards-search-frontmatter-values");
