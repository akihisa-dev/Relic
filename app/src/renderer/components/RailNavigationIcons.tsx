...
export const IconChronicle = (): ReactElement => (
  <svg fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="18">
    <path d="M4 12h.01" />
    <path d="M4 16h.01" />
    <path d="M4 20h.01" />
...
export const IconGraph = (): ReactElement => (
  <svg fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="18">
    ...
    <path d="M15.8 7.4 13.2 16" />
    <path d="M8.5 6h7" />
  </svg>
);

export const IconSphere = (): ReactElement => (
  <svg fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" width="18">
    <circle cx="12" cy="12" r="9" />
    <ellipse cx="12" cy="12" rx="4" ry="9" />
    <path d="M3 12h18" />
    <path d="M5.5 7.5c2 1.1 4.2 1.7 6.5 1.7s4.5-.6 6.5-1.7" />
    <path d="M5.5 16.5c2-1.1 4.2-1.7 6.5-1.7s4.5.6 6.5 1.7" />
  </svg>
);
