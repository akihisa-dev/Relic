...
import { clamp } from "./timelineTimelineAxis";
import { entryKey } from "./timelineTimelineRows";
...
export function minimapItemsForEntries(entries: TimelineChartEntry[], axisStart: number, axisEnd: number): MinimapItem[] {
...
export function timelineNavigationTarget(entries: TimelineChartEntry[], axisStart: number, axisEnd: number): number | null {
