...
Relicの開発フェーズを管理する正本。
AIは `AGENTS.md` と `docs/product/project.md` の次にこのファイルを読み、現在フェーズと必要文書を判断する。
...
| P00 | P00 | current | `phases/P00.md`, 必要に応じて `../spec/`, `../product/PLAN.md`, `../product/principles.md`, `../ui/`, `../architecture/overview.md`, `conventions.md`, `testing.md` |
...
- フェーズ固有のルール、制約、作業記録は、各フェーズ正本へ書く
- 各フェーズ正本の作業記録は日時付きで書く
- 各フェーズ正本に作業記録を書いた場合は、その時点のすべての差分を作業記録の単位でコミットし、コミット後にpushする
