...
current: P20
summary: 大型機能追加
checklist: phases/P20-major-feature-addition.md
```
...
| P20 | 大型機能追加 | current | `phases/P20-major-feature-addition.md`, `conventions.md`, `testing.md`, 必要に応じて `../spec/`, `../architecture/overview.md`, `../ui/` |
