...
current: P18
summary: UX/UIデザイン修正
checklist: phases/P18-ui-ux-design-fixes.md
```
...
| P18 | UX/UIデザイン修正 | current | `phases/P18-ui-ux-design-fixes.md`, `../ui/screens-macos.md`, `../ui/navigation.md`, `../ui/DESIGN.md` |
...
- 実装したUX/UI判断は、方向性・実施・確認・残りを同じ項目に記録する
