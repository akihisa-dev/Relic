...
```yaml
current: P17
summary: 機能再考（ヒアリング起点）
checklist: phases/P17-feature-reconsideration.md
```
...
| P17 | 機能再考（ヒアリング起点） | current | `phases/P17-feature-reconsideration.md`, 必要に応じて `../spec/`, `../PLAN.md`, `../principles.md` |
