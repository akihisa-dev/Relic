...
```yaml
current: P14
summary: GitHub連携の安全導入
checklist: phases/P14-github-integration.md
```
...
| P14 | GitHub連携の安全導入 | current | `phases/P14-github-integration.md`, `../spec/github.md`, `../tech/git-implementation.md`, `../architecture/decisions.md` |
