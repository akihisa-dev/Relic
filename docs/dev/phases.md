...
current: P15
summary: UI/UXの洗練
checklist: phases/P15-ui-ux-polish.md
```
...
| P15 | UI/UXの洗練 | current | `phases/P15-ui-ux-polish.md`, `../ui/screens-macos.md`, `../ui/navigation.md`, `../ui/DESIGN.md` |
...
GitHub機能の追加実装をいったん凍結し、RelicのUI/UXを洗練するフェーズ。

AIはこのフェーズを前提にユーザーへ接する。
最初に現状の主要画面を確認し、「つまらなさ」の原因を情報設計・視覚設計・文言・操作感に分けて整理する。

最初に読む:

- `phases/P15-ui-ux-polish.md`
