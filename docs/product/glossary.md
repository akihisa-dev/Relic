...
| Chronicleタブ | Chart tab | `GanttTab`, `kind: "gantt"`, `openGanttChartInPane`, `gantt-charts`, `renderChronicleTab` | `app/src/renderer/store/editorStore.ts`, `app/src/renderer/store/editorStoreModel.ts`, `app/src/renderer/hooks/useAppTabRenderers.tsx` | [navigation](../ui/navigation.md), [screens-macos](../ui/screens-macos.md) |
| Chronicle | Chronicle | `chronicle`, `GanttChartSource`, `WorkspaceGanttChart`, `defaultGanttCharts`, `ChronicleView`, `useWorkspaceChronicle` | `app/src/shared/ipc.ts`, `app/src/main/files/chronicle.ts`, `app/src/renderer/components/ChronicleSidebar.tsx`, `app/src/renderer/chronicleChartData.ts` | [frontmatter](../spec/frontmatter.md), [data-model](../architecture/data-model.md), [screens-macos](../ui/screens-macos.md) |
