...
| 画面構成、操作導線、テーマ | [デザイン正本](design/DESIGN.md) | [ナビゲーション仕様](features/navigation.md)、[色と質感の原則](design/LIQUID_CHARCOAL.md) |
...
| 文書 | 役割 |
|------|------|
| [design/DESIGN.md](design/DESIGN.md) | 画面構成、遷移、デザインシステムの正本 |
| [design/LIQUID_CHARCOAL.md](design/LIQUID_CHARCOAL.md) | 色、素材、質感の基礎原則 |
...
| 場所 | 役割 |
|------|------|
| `app/src/main/` | ファイル、設定、ワークスペース、IPCなどOS側の処理 |
| `app/src/preload/` | レンダラーへ公開する安全なAPI |
| `app/src/renderer/` | React UI、エディタ、画面状態 |
| `app/src/shared/` | main、preload、rendererで共有する型と純粋関数 |
| `app/scripts/` | ビルド、検証、生成の補助スクリプト |
