...
|---------|---------|---------|------------|
| `@codemirror/autocomplete` | `6.20.3` | MIT | [link](https://code.haverbeke.berlin/codemirror/autocomplete) |
| `@codemirror/commands` | `6.10.3` | MIT | [link](https://github.com/codemirror/commands) |
| `@codemirror/lang-markdown` | `6.5.0` | MIT | [link](https://github.com/codemirror/lang-markdown) |
| `@codemirror/language` | `6.12.3` | MIT | [link](https://github.com/codemirror/language) |
| `@codemirror/state` | `6.6.0` | MIT | [link](https://github.com/codemirror/state) |
| `@codemirror/view` | `6.43.0` | MIT | [link](https://code.haverbeke.berlin/codemirror/view) |
...
| `js-yaml` | `4.2.0` | MIT | [link](https://github.com/nodeca/js-yaml) |
