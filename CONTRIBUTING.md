...
- 実装を正とし、推測で仕様を書かないでください。
- README、`docs/`、画面文言、実装の説明が食い違う場合は、実装を確認したうえで文書を更新してください。
- 未実装の内容を、実装済みの機能として書かないでください。
- ユーザーのデータ保存形式やファイル操作の意味が変わる変更では、関連する仕様・設計文書も更新してください。
